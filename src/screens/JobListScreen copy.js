...
// import { getChangeDate } from "../utility/date";
...
//     }
//     try {
//       const result = await callService(4, "%", stadate, personelSorguName);
//       if (result) {
//         if (result.length > 0) {
//           setServices(result);
//         } else {
...
//         const dateA = getChangeDate(a.TECDATE);
//         const dateB = getChangeDate(b.TECDATE);
